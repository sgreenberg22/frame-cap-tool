          ...
          <div className="canvasWrap" style={{marginTop:12}}>
            {src ? (
              ...
              <div style={{padding:20,color:'var(--muted)'}}>
                ...
                <div className="controls"><CaptureControls onFile={onFile} speed={speed} setSpeed={setSpeed} playing={playing} onPlayPause={onPlayPause} onSingleShot={capture} onBatch={batch} disable={!src} /></div>
              </div>
            )}
          </div>
